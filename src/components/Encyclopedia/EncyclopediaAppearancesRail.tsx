...
import { SCENE_STATUS_META, type EncyclopediaEntry } from "@/lib/types";
import type { EncyclopediaAppearance } from "@/lib/encyclopedia";
import { cn } from "@/lib/utils";

export function EncyclopediaAppearancesRail({
  appearances,
  onOpenScene,
}: {
...
export function EncyclopediaBackLink() {
  return (
    <Link
      href="/encyclopedia"
...
export function encyclopediaHref(e: EncyclopediaEntry) {
  return `/encyclopedia/${e.id}`;
}
